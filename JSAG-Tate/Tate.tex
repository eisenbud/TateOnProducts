...
\noindent
Strictly speaking the two terms in homological degree $-2$ and $-1$ are not part of the Tate resolution but rather trailing terms, which come from the construction of $T$ as a corner complex. We will return to this issue in \ref{sec:corner complex}.
