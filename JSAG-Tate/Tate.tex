...
Given a projective scheme $X \subset \PP^n$, a morphism
$$\pi \colon X \to \PP^m$$ and a coherent sheaf $\sF$ on $X$, we can use our methods to compute $R\pi_* \sF \in D^b(\PP^m)$:
