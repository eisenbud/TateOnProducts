...
%(The map between the terms in homological degree $-2$ and $-1$ is actually not part of the Tate resolution but  comes from the construction of $\operatorname{Tail}_b(M)$ as a corner complex. See \S\ref{sec:cornercomplex}). 
