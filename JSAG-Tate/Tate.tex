...
This paper is organized as follows.  In Section~\ref{sec:background} we briefly review the BGG correspondence and Tate resolutions.  In Section~\ref{sec:cohom tables}, we discuss the command {\tt cohomologyTable}.  
