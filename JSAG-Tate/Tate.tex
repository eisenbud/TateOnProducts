...
Continuing with the example above, we compute the Beilinson Monad of the 
sheaf corresponding to $M$:
\begin{verbatim}
B = beilinsonMonad M
\end{verbatim}
...
while the other cohomology is trivial as a sheaf. This is not necessarily true as modules,
however. In this case, M has a generator in degree $\{-1,1\}$, but ${\rm H}^0 B$ does not.
